...
library(ggplot2)
library(patchwork)
setwd("/Users/sestelo/Library/CloudStorage/Dropbox/research/inprogress/cif_cluster/revision/code_github/02_outputs_sims/")
...
for(cen in censuras){
  for(n in ns){
    file <- paste0("./experiment_3/res_cif_scenario3_", algo,"_cen",cen,"_n_",n,".Rda" )
    load(file)
    aux <- rbind(aux, out)
  }
}
